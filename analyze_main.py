...
if __name__ == '__main__':
    ...
    if "mnist" in DEFAULT_CONFIG.lower() or "svhn" in DEFAULT_CONFIG.lower():
        ...
        # for cifar (resnet styple network): `head_B.heads[0] with feature size 10`, `trunk.avgpool with feature size 512`,
        # `trunk.layer4 with feature size 512, 3, 3`
        for i in range(5):
            try:
    ...
    # clusteringTrainer.draw_tsne(val_loader, num_samples=500)

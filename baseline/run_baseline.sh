...
# CIFAR IIC
python train_original.py Config=config_CIFAR.yaml Trainer.save_dir=baseline/cifar/iicgeo Trainer.name=iicgeo \
 Trainer.head_control_params={A:2,B:1} Arch.num_sub_heads=5 Arch.name=clusternet5gTwoHead Arch.num_channel=2 \
Optim.lr=0.0001 Trainer.use_sobel=True Trainer.max_epoch=1000
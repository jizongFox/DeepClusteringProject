...
class Cifar10SemiSupervisedDatasetInterface(SemiDatasetInterface):
    ...
    def __init__(self, data_root=None, labeled_sample_num: int = 4000, img_transformation: Callable = None,
    ...
    def _init_train_and_test_test(self, transform, target_transform, *args, **kwargs) -> Tuple[Dataset, Dataset]:
        ...
        train_set = self.DataClass(self.data_root, train=True, transform=transform, target_transform=target_transform,
                                   download=True,
                                   *args, **kwargs)
        val_set = self.DataClass(self.data_root, train=False, transform=transform, target_transform=target_transform,
                                 download=True,
                                 *args, **kwargs)
